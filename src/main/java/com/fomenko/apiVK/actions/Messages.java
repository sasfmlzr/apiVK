...
public class Messages extends AbstractAction {
    ...
    public void vkSendMessage(UserActor actor, String message, List<Dialog> messagesList) throws  ClientException, ApiException {
        new com.fomenko.apiVK.functions.message.Messages(getClient().getVkApiClient()).vkSendMessage(actor, message, messagesList, super.getClient().getVkApiClient());
    }

    public void vksendImageMessages(UserActor actor, List<Dialog> messagesList) throws ClientException, ApiException{
        new com.fomenko.apiVK.functions.message.Messages(getClient().getVkApiClient()).vksendImageMessages(actor,  messagesList, super.getClient().getVkApiClient());
    }

    public void vkSendMessageUser(UserActor actor, String message, int userID) throws ClientException, ApiException {
        new com.fomenko.apiVK.functions.message.Messages(getClient().getVkApiClient()).vkSendMessageUser(actor,message,userID, super.getClient().getVkApiClient());
    }
    ...
    public Commands commands (){ return new com.fomenko.apiVK.actions.Commands(getClient());}
    public Functional functional() {return new com.fomenko.apiVK.actions.Functional(getClient());}
