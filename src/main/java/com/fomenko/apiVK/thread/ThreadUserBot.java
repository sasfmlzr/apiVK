package com.fomenko.apiVK.thread;


import com.fomenko.apiVK.client.BotApiClient;
import com.fomenko.apiVK.object.UserRights;
...
import static com.fomenko.apiVK.object.StatisticsVariable.*;
...
public class ThreadUserBot extends ThreadBot implements Runnable 		//(содержащее метод run())          отправление сообщения в рекурсии в отдельном потоке
{
    ...
    public ThreadUserBot(com.fomenko.apiVK.client.BotApiClient client, UserActor actor) {
        this.client=client;
        this.actor=actor;
    }
